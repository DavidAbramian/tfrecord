...
# data = load_data_3D(subfolder='ABIDE_192cubes_augmented2')
# data = load_data_3D(subfolder='ABIDE_192cubes_augmented2_2')
...
# Create labels
# Y = np.concatenate( (np.zeros(529*2), np.ones(505*2)), axis=None )
# Y = np.concatenate( (np.zeros(24), np.ones(24)), axis=None )
